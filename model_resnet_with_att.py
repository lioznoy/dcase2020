...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, reduction_ratio=1, kernel_cbam=3, use_cbam_block=False,
...
def ResNetk(k, reduction_ratio=1, kernel_cbam=3, use_cbam_block=False, use_cbam_class=False):
    ...
    if k == 18:
        return ResNet18(reduction_ratio=reduction_ratio, kernel_cbam=kernel_cbam, use_cbam_block=use_cbam_block,
                        use_cbam_class=use_cbam_class)
    elif k == 34:
        return ResNet34(reduction_ratio=reduction_ratio, kernel_cbam=kernel_cbam, use_cbam_block=use_cbam_block,
                        use_cbam_class=use_cbam_class)
    elif k == 50:
        return ResNet50(reduction_ratio=reduction_ratio, kernel_cbam=kernel_cbam, use_cbam_block=use_cbam_block,
                        use_cbam_class=use_cbam_class)
    elif k == 101:
        return ResNet101(reduction_ratio=reduction_ratio, kernel_cbam=kernel_cbam, use_cbam_block=use_cbam_block,
                         use_cbam_class=use_cbam_class)
    elif k == 152:
        return ResNet152(reduction_ratio=reduction_ratio, kernel_cbam=kernel_cbam, use_cbam_block=use_cbam_block,
                         use_cbam_class=use_cbam_class)
